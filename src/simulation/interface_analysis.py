...
from ..billing import (
    ...
    PGE_B6_SECONDARY_POLYPHASE_BUNDLED_2025,
    PGE_B6_SECONDARY_SINGLE_PHASE_BUNDLED,
    PGE_B6_SECONDARY_SINGLE_PHASE_BUNDLED_2025,
...
REGION_RETAIL_TARIFF_IDS = {
    "caiso_np15": (
        ...
        PGE_B6_SECONDARY_SINGLE_PHASE_BUNDLED_2025.tariff_id,
        PGE_B6_SECONDARY_POLYPHASE_BUNDLED.tariff_id,
        PGE_B6_SECONDARY_POLYPHASE_BUNDLED_2025.tariff_id,
...
TARIFF_ELIGIBILITY_CEILING_KW = {
    ...
    PGE_B6_SECONDARY_SINGLE_PHASE_BUNDLED_2025.tariff_id: 75.0,
    PGE_B6_SECONDARY_POLYPHASE_BUNDLED.tariff_id: 75.0,
    PGE_B6_SECONDARY_POLYPHASE_BUNDLED_2025.tariff_id: 75.0,
