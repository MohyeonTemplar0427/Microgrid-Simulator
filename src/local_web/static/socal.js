...
(() => {
 ...
 function request(){
  ...
  for(const n of ['eligibility_confirmed','ordinary_account_confirmed','cycle_confirmed','tax_confirmed','region_confirmed','interconnection_confirmed','heat_pump_water','non_cpp_confirmed','reactive_charge_exempt_confirmed','gwp_individual_meter_confirmed','gwp_allocation_confirmed','storage_schedule_confirmed','gwp_demand_history_confirmed','pwp_flat_enrollment_confirmed','pwp_r2_qualification_confirmed','pwp_storage_confirmed','alw_ordinary_meter_confirmed','alw_storage_confirmed','bwp_ecac_confirmed','bwp_ev_confirmed','bwp_c_confirmed','ipu_domestic_confirmed','municipal_storage_confirmed'])a[n]=f(n).checked;
