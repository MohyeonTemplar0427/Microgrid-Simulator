...
256 seeded, stratified samples from 1328 county models;
...
The represented stock includes vacant units; per-home values use all housing units.
Full county modeled mean: 10118.0 kWh/home/year.
Sample mean: 9749.1; discrepancy -3.65%.
Estimated sampling standard error: 263.6 kWh/home/year;
...
|---|---:|---:|---:|---:|
| published_2018_full | 8760 | 9749.1 | 3532.9 | 3.106 |
| noaa_summer_2018 | 2928 | 4362.6 | 2486.9 | 3.177 |
| noaa_summer_2024 | 2928 | 4649.5 | 2779.7 | 3.632 |
| temperature_only_2024 | 2928 | 4649.5 | 2779.7 | 3.632 |
...
RMSE: 16.09 kW for 100 homes;
normalized RMSE: 16.1%;
energy bias: +1.8%.
...
```bash
/usr/local/bin/python3 tools/run_fresno_residential_study.py --download --sample-size {summary['sample_models']} --output {output}
```
