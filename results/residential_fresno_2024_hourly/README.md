# Fresno County, CA: 2024 occupied-home hourly load
...
Station: Fresno Yosemite International Airport (72389093193). 2
...
supply the end of the local year. 66 hours
...
contains 256 of 1236 occupied county models; its baseline annual
...
+1.68%, hourly normalized RMSE 15.47%.
...
```bash
python3 tools/build_county_residential_year.py --county fresno --year 2024 --sample-size 256 --households 100 --download --output /Users/junhayang/Desktop/EnergyEngineerSession/Microgrid_Simulator/results/residential_fresno_2024_hourly
```
